...
const NoteGriditem = ({ data }) => {
  return (
    <div className="bg-white h-40 w-full rounded-2xl overflow-hidden shadow-lg cursor-pointer group">
      {/* Item Heading */}
      <div className="w-full bg-gray-200 px-5 py-2 pt-2 flex justify-between items-center">
        ...
        <button className="cursor-pointer" onClick={()=> console.log(data._id)}>
          <Trash2
            size={20}
